...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  if (nrhs > 1) {
    ...
    if (mxGetField(prhs[1], 0, "eps") != NULL)
      st.eps = *mxGetPr(mxGetField(prhs[1], 0, "eps"));

    if (mxGetField(prhs[1], 0, "max_iters") != NULL)
      st.max_iters = *mxGetPr(mxGetField(prhs[1], 0, "max_iters"));

    if (mxGetField(prhs[1], 0, "refine_steps") != NULL)
      st.refine_steps = *mxGetPr(mxGetField(prhs[1], 0, "refine_steps"));

    if (mxGetField(prhs[1], 0, "verbose") != NULL)
      st.verbose = *mxGetPr(mxGetField(prhs[1], 0, "verbose"));

    if (mxGetField(prhs[1], 0, "better_start") != NULL)
      st.better_start = *mxGetPr(mxGetField(prhs[1], 0, "better_start"));

    if (mxGetField(prhs[1], 0, "verbose_refinement") != NULL)
      st.verbose_refinement = *mxGetPr(mxGetField(prhs[1], 0,
            "verbose_refinement"));

    if (mxGetField(prhs[1], 0, "debug") != NULL)
      st.debug = *mxGetPr(mxGetField(prhs[1], 0, "debug"));

    if (mxGetField(prhs[1], 0, "kkt_reg") != NULL)
      st.e = *mxGetPr(mxGetField(prhs[1], 0, "kkt_reg"));

    if (mxGetField(prhs[1], 0, "s_init") != NULL)
      st.s_init = *mxGetPr(mxGetField(prhs[1], 0, "s_init"));

    if (mxGetField(prhs[1], 0, "z_init") != NULL)
      st.z_init = *mxGetPr(mxGetField(prhs[1], 0, "z_init"));

    if (mxGetField(prhs[1], 0, "resid_tol") != NULL)
      st.resid_tol = *mxGetPr(mxGetField(prhs[1], 0, "resid_tol"));
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 50) && (mxGetN(xm) == 50))) {
      printf("A must be size (50,50), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 50) && (mxGetN(xm) == 20))) {
      printf("B must be size (50,20), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 50) && (mxGetN(xm) == 50))) {
      printf("Q must be size (50,50), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 20) && (mxGetN(xm) == 20))) {
      printf("R must be size (20,20), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 50) && (mxGetN(xm) == 1))) {
      printf("x_0 must be size (50,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
  ...
  if (prepare_for_c) {
    printf("st.prepare_for_c == 1. thus, outputting for C.\n");
    for (i = 0; i < 50; i++)
      printf("  p.x_0[%d] = %.6g;\n", i, p.x_0[i]);
    for (i = 0; i < 2500; i++)
      printf("  p.Q[%d] = %.6g;\n", i, p.Q[i]);
  ...
  *mxGetPr(xm) = w.converged;
  ...
  xm_cell = mxCreateDoubleMatrix(20, 1, mxREAL);
  ...
  xm = mxCreateDoubleMatrix(50, 1, mxREAL);
  mxSetField(plhs[0], 0, "x_1", xm);
  xm_cell = mxCreateDoubleMatrix(50, 1, mxREAL);
